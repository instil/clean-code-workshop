...
const RefactoringExercise: FC = () => {
	...
	let peterPan: Movie = {title: "Peter Pan", priceCode: "CHILDRENS"};
	let theHulk: Movie = {title: 'The Hulk', priceCode: 'REGULAR'};
	let starWars: Movie = {title: 'Star Wars', priceCode: 'REGULAR'};
	let toyStory: Movie = {title: 'Toy Story', priceCode: 'CHILDRENS'};
	let drive: Movie = {title: 'Drive', priceCode: 'NEW_RELEASE'};
	...
	customer.appendRental(r1);
	customer.appendRental(r2);
	customer.appendRental(r3);
	customer.appendRental(r4);
	customer.appendRental(r5);

	customerStatement = customer.generateStatement();
	...
	return (
			...
			<p className="refactoring-exercise__results">{customerStatement}</p>
			<TypingCaret/>
			</div>
			</>
		   );
